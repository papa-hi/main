...
async function sendWelcomeToCollins() {
  const resend = new Resend(process.env.RESEND_API_KEY);
  
  console.log('Sending welcome email to collins (lidedecollins@gmail.com)...');
  
  try {
    const { data, error } = await resend.emails.send({
      from: 'PaPa-Hi <papa@papa-hi.com>',
      to: ['lidedecollins@gmail.com'],
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <h1 class="welcome-title">Welcome to PaPa-Hi, Collins! 🎉</h1>
            </div>
            
            <div class="content">
              <p>Hi <strong>Collins</strong>,</p>
              ...
              <p>Your account is now ready, and you can start exploring everything PaPa-Hi has to offer:</p>
...
Your account is now ready, and you can start exploring everything PaPa-Hi has to offer:
...
© 2025 PaPa-Hi. Made with ❤️ for Dutch families.
    ...
    if (error) {
      console.error('Error sending welcome email to Collins:', error);
      return false;
    }

    console.log('Welcome email sent successfully to Collins!');
    ...
    console.error('Failed to send welcome email to Collins:', error);
    return false;
  }
}

sendWelcomeToCollins();